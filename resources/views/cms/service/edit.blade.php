@extends('layouts.app')
@section('title', 'Edit Service: ' . $data->id)
...
<div class=" card card-custom gutter-b example example-compact">
    ...
    {!! Form::model($data, array('route' => array('cms.service.update',$data->id, 'class'=>
    'form')))!!}
    @method('PUT')
            ...
            <div class="col-lg-12">
                ...
                <div class="image-input w-100" id="image_file">
                    <div class="image-input-wrapper" style="background-color: whitesmoke !important; 
                        background-image: url('{{ asset('storage/services/'.$data->image) }}');
