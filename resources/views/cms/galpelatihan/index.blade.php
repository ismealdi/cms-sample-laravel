@extends('layouts.app')
@section('title', 'galpelatihan')
@section('subheader', true)
@section('buttons')
<a href="{{ route('cms.galpelatihan.create') }}" class="btn btn-light-primary font-weight-bold ml-2">Add galpelatihan</a>
@endsection
@section('pagination')
    ...
    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6" data-route="item-data-{{ $item->id }}">
        ...
        <div class="card card-custom gutter-b card-stretch">
            ...
            <div class="card-body text-center pt-4">
                    ...
                    <div class="dropdown dropdown-inline">
                        ...
                        <div class="dropdown-menu dropdown-menu-xs dropdown-menu-right">
                            ...
                            <ul class="navi navi-hover">
                                <li class="navi-item">
                                    <a href="{{ route('cms.galpelatihan.edit', $item->id) }}" class="navi-link">
                                ...
                                <li class="navi-item">
                                    <a class="navi-link delete"
                                        data-route="{{ route('cms.galpelatihan.destroy', $item->id) }}">
                ...
                <!--end::Toolbar-->
                <div class="mt-7">
                    <img src="{{ asset('storage/galpelatihan/'.$item->image) }}" alt="image" class="image-slider rounded">
                </div>
                <div class="my-4">
