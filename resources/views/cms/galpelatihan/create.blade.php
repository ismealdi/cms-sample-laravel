@extends('layouts.app')
@section('title', 'Create galpelatihan')
...
<div class="card card-custom gutter-b example example-compact">
    ...
    <form class="form" action="{{ route('cms.galpelatihan.store') }}" method="POST">
        @csrf
        ...
        <div class="card-body">
            <div class="form-group row">
                <div class="col-lg-12">
                    <label>Name:</label>
                    <input type="text" name="name" class="form-control" placeholder="Enter galpelatihan Name" required />
