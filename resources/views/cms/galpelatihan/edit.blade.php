@extends('layouts.app')
@section('title', 'Edit galpelatihan: ' . $data->name)
...
<div class="card card-custom gutter-b example example-compact">
    ...
    {!! Form::model($data, array('route' => array('cms.galpelatihan.update', $data->id, 'class' =>
    'form'))) !!}
    @method('PUT')
    ...
    <div class="card-body">
        <div class="form-group row">
            <div class="col-lg-12">
                ...
                'placeholder' => 'Enter galpelatihan Name']) !!}
                <span class="form-text text-muted">Please enter your galpelatihan name</span>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-lg-12">
                ...
                <div class="image-input w-100" id="image_file">
                    <div class="image-input-wrapper" style="background-color: whitesmoke !important; 
                        background-image: url('{{ asset('storage/galpelatihan/'.$data->image) }}');
        ...
        <div class="form-group row">
            <label class="col-form-label text-left col-lg-3 col-sm-12">Status galpelatihan</label>
    ...
    <div class="card-footer">
        <div class="row">
            <div class="col-lg-6">
                <a href="{{ route('cms.galpelatihan.index') }}" type="reset" class="btn btn-secondary">Cancel</a>
            </div>
