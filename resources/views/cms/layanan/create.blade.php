@extends('layouts.app')
@section('layanan', 'Create layanan')
    ...
    <form class="form" action="{{ route('cms.layanan.store') }}" method="post">
        ...
        <div class="card-body">
            <div class="form-group row">
                <div class="col-lg-12">
                    <label>Name:</label>
                    <input type="text" class="form-control" placeholder="Enter layanan Name" name="name" required />
            ...
            <div class="form-group row">
                <div class="col-lg-12">
                    <label>Konten:</label>
                    <input type="text" class="form-control" placeholder="Enter layanan Name" name="konten" required />
