@extends('layouts.app')
@section('title', 'Edit Layanan: ' . $data->id)
...
<div class=" card card-custom gutter-b example example-compact">
    ...
    {!! Form::model($data, array('route' => array('cms.layanan.update',$data->id, 'class'=>
    'form')))!!}
    @method('PUT')
    ...
    <div class="card-body">
        <div class="form-group row">
            ...
            <div class="col-lg-12">
                <label>Konten:</label>
                {!!Form::text('konten', null, ['class'=>'form-control','required',
                'placeholder'=>'Enter Service Name']) !!}
                <span class="form-text text-muted">Please Enter Your Mini konten Name</span>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-lg-12">
                ...
                <div class="image-input w-100" id="image_file">
                    <div class="image-input-wrapper" style="background-color: whitesmoke !important; 
                        background-image: url('{{ asset('storage/layanans/'.$data->image) }}');
