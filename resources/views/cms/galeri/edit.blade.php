@extends('layouts.app')
@section('title', 'Edit galeri: ' . $data->name)
...
<div class="card card-custom gutter-b example example-compact">
    ...
    {!! Form::model($data, array('route' => array('cms.galeri.update', $data->id, 'class' =>
    'form'))) !!}
    @method('PUT')
            ...
            <div class="col-lg-12">
                ...
                <div class="image-input w-100" id="image_file">
                    <div class="image-input-wrapper" style="background-color: whitesmoke !important; 
                        background-image: url('{{ asset('storage/galeri/'.$data->image) }}');
    ...
    <div class="card-footer">
        <div class="row">
            <div class="col-lg-6">
                <a href="{{ route('cms.galeri.index') }}" type="reset" class="btn btn-secondary">Cancel</a>
            </div>
