...
@section('buttons')
<a href="{{ route('cms.galeri.create') }}" class="btn btn-light-primary font-weight-bold ml-2">Add galeri</a>
@endsection
@section('pagination')
    ...
    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6" data-route="item-data-{{ $item->id }}">
        ...
        <div class="card card-custom gutter-b card-stretch">
            ...
            <div class="card-body text-center pt-4">
                ...
                <!--end::Toolbar-->
                <div class="mt-7">
                    <img src="{{ asset('storage/galeri/'.$item->image) }}" alt="image" class="image-slider rounded">
                </div>
                <div class="my-4">
