...
@section("content")
@include('layouts.components.web.titleinap')
@include('layouts.components.web.sidebarinap')
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="ttm-service-description">
                                        <h4>Poliklinik Eksekutif</h4>
                                        <div class="sep_holder_box width-100 mb-20">
                                            <span class="sep_holder"><span class="sep_line"></span></span>
                                            <span class="sep_holder"><span class="sep_line"></span></span>
                                        </div>
                                        <div class="mb-35">
                                            <p>Poliklinik Eksekutif Rumah Sakit Paru Dr.M.Goenawan Partowidigdo (RSPG) Cisarua Bogor merupakan poliklinik eksklusif yang melayani dokter umum, spesialis & sub spesialis, penunjang medik yang lengkap serta didukung dengan hadirnya ratusan rekanan asuransi kesehatan yang telah bekerjasama, </p>
                                            <p>Jam pelayanan yang panjang yaitu pukul 08.00 hingga pkl.  21.00 WIB (tergantung jadwal dokter) dapat memudahkan pasien untuk memilih waktu kunjungan yang disesuaikan dengan kesibukannya masing-masing.</p>
