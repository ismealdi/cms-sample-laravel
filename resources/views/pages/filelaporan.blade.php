        ...
        <div class="card-box">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-xl-3">
                    <a href="{{ asset('storage/docpdf/'.$document->file) }}" target="blank" class="file-img-box"><img src="{{url('/images/pdf.svg')}}" alt="icon" width="180">
                    </a>
                    <div class="file-man-title">
                        <h5 class="mb-0 text-overflow">{{ ucwords($document->name) }}</h5>
                        <p class="mb-0"><small>{{ $document->getFileSize() }}</small></p>
                    </div>
                </div>
                @endforeach
            </div>
