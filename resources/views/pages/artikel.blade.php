                    ...
                    <div class="ttm-blog-classic-content">
                        <div class="ttm-post-entry-header">
                            <div class="post-meta">
                                ...
                                <span class="ttm-meta-line cat-links"><i class="ti ti-folder"></i>Cardiac, Medical</span>
                                <span class="ttm-meta-line comments-link"><i class="fa fa-comment"></i> 3 Comments</span>
                                <span class="ttm-meta-line tags-links"><i class="fa fa-tag"></i>doctor, pain</span>
                            </div>
                            <header class="entry-header">
                                <h2 class="entry-title"><a href="single-blog.html">How much aspirin to take for stroke</a></h2>
                            </header>
                        </div>
                        <div class="entry-content">
                            <div class="ttm-box-desc-text">
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s sta.It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more Aldus PageMaker including versions of Lorem Ipsum.</p>
                            </div>
                            <div class="ttm-blogbox-desc-footer">
                                <div class="ttm-blogbox-footer-readmore">
                                    <div class="ttm-blogbox-footer-left">
                                        <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-color-black" href="#">READ MORE</a>
                                    </div>
                                </div>
                ...
                <article class="post ttm-blog-classic clearfix">
                    ...
                    <div class="ttm-blog-classic-content">
                        <div class="ttm-post-entry-header">
                            ...
                            <header class="entry-header">
                                <h2 class="entry-title"><a href="single-blog.html">Implant Surgical equipment technology</a></h2>
                            </header>
                        </div>
                        <div class="entry-content">
                            <div class="ttm-box-desc-text">
                ...
                <article class="post ttm-blog-classic clearfix">
                    ...
                    <div class="ttm-blog-classic-content">
                        <div class="ttm-post-entry-header">
                            ...
                            <header class="entry-header">
                                <h2 class="entry-title"><a href="single-blog.html">The Benefits of Middle-Age Fitness</a></h2>
                            </header>
                        </div>
                        <div class="entry-content">
                            <div class="ttm-box-desc-text">
                ...
                <article class="post ttm-blog-classic clearfix">
                    ...
                    <div class="ttm-blog-classic-content">
                        <div class="ttm-post-entry-header">
                            ...
                            <header class="entry-header">
                                <h2 class="entry-title"><a href="single-blog.html">Good Reasons to Break the Fast-Food Habit</a></h2>
                            </header>
                        </div>
                        <div class="entry-content">
                            <div class="ttm-box-desc-text">
                ...
                <article class="post ttm-blog-classic clearfix">
                    ...
                    <div class="ttm-blog-classic-content">
                        <div class="ttm-post-entry-header">
                            ...
                            <header class="entry-header">
                                <h2 class="entry-title"><a href="single-blog.html">Adding Milk to Tea Destroys its Antixidants</a></h2>
                            </header>
                        </div>
                        <div class="entry-content">
                            <div class="ttm-box-desc-text">
