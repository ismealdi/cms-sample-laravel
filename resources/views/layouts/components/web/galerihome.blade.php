  ...
  <div class="section-title res-991-pt-30">
        ...
        <div class="owl-carousel owl-2">
          <div class="media-29101">
            <a href="#"><img src="{{asset('carousel/images/img_1.jpg')}}" alt="Image" class="img-fluid"></a>
            <h3><a href="#">Consectetur Adipisicing Elit</a></h3>
          </div>
          <div class="media-29101">
            <a href="#"><img src="{{asset('carousel/images/img_2.jpg')}}" alt="Image" class="img-fluid"></a>
            <h3><a href="#">Beatae Doloribu</a></h3>
          </div>
          <div class="media-29101">
            <a href="#"><img src="{{asset('carousel/images/img_3.jpg')}}" alt="Image" class="img-fluid"></a>
            <h3><a href="#">Accusantium Eius Soluta</a></h3>
          </div>
          <div class="media-29101">
            <a href="#"><img src="{{asset('carousel/images/img_4.jpg')}}" alt="Image" class="img-fluid"></a>
            <h3><a href="#">Consectetur Adipisicing Elit</a></h3>
          </div>
          <div class="media-29101">
            <a href="#"><img src="{{asset('carousel/images/img_5.jpg')}}" alt="Image" class="img-fluid"></a>
            <h3><a href="#">Beatae Doloribu</a></h3>
          </div>
          <div class="media-29101">
            <a href="#"><img src="{{asset('carousel/images/img_6.jpg')}}" alt="Image" class="img-fluid"></a>
            <h3><a href="#">Accusantium Eius Soluta</a></h3>
          </div>
        </div>
