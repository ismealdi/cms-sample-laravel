                    ...
                    <aside class="widget widget-text">
                        ...
                        <div class="featured-icon-box iconalign-before-heading">
                            ...
                            <div class="featured-title">
                                <h5>(0251) 8253630</h5>
                                <h4>Punya pertanyaan ? hubungi kami sekarang</h4>
                            </div>
                ...
                <div class="widget-area col-xs-12 col-sm-12 col-md-6 col-lg-4">
                    <aside class="widget widget-text">
                        ...
                        <div class="featured-icon-box iconalign-before-heading">
                            ...
                            <div class="featured-title">
                                <h5>info@rspg-cisarua.co.id</h5>
                                <h4>Butuh bantuan ? Kirimi kami email</h4>
                            </div>
                        </div><!-- featured-icon-box end-->
                    </aside>
                </div>
                <div class="widget-area col-xs-12 col-sm-12 col-md-6 col-lg-4">
                    <aside class="widget widget-text">
                        ...
                        <div class="featured-icon-box iconalign-before-heading">
                            ...
                            <div class="featured-title">
                                <h5>Senin – Jum'at 07:30 – 16:30</h5>
                                <h4>Kami buka</h4>
                            </div>
                        </div><!-- featured-icon-box end-->
                    </aside>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 widget-area">
                    <div class="widget widget_text clearfix">
                        ...
                        <div class="textwidget widget-text">
                            Rumah sakit kami memberikan layanan yang komprehensif melalui perpaduan dari
                            fasilitas rumah sakit dan sumber daya manusia yang profesional di bidangnya.
                            <br><br>Dengan melakukan perbaikan yang berkesinambungan dari waktu ke waktu.
                            <br><br>
                            <div class="social-icons social-hover">
                                <ul class="list-inline">
                                    ...
                                    <li class="social-twitter"><a class="tooltip-top" target="_blank" href="#"
                                            data-tooltip="Twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                    </li>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 widget-area">
                    <div class="widget widget_nav_menu clearfix">
                        ...
                        <ul id="menu-footer-services-menu">
                            ...
                            <li><a href="#">Poliklinik Executive</a></li>
                            <li><a href="#">Geriatri</a></li>
                            <li><a href="#">Geust House</a></li>
                        </ul>
                    </div>
                    <div class="widget widget-text clearfix">
                        <h3 class="widget-title">Buletin</h3>
    ...
    <div class="bottom-footer-text ttm-textcolor-white">
        <div class="container">
            <div class="row copyright">
                <div class="col-md-12">
                    <span>Copyright © 2024 Rumah Sakit Paru Dr. M. Goenawan Partowidigdo Cisarua by <a href="#">Tim IT
                            RSPG</a></span>
                </div>
                <div class="col-md-12">
